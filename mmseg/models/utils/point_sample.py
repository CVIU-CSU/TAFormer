...
def get_uncertainty(mask_preds: Tensor, labels: Tensor, is_uncertain: bool = True) -> Tensor:
...
def get_uncertain_point_coords_with_randomness(
        ...
        oversample_ratio: float, importance_sample_ratio: float,
        is_uncertain: bool = True) -> Tensor:
    ...
    point_uncertainties = get_uncertainty(point_logits, labels, is_uncertain)
