...
class MultiTaskMask2FormerHeadLearnGenerateQuery(MMDET_Mask2FormerHead):
    ...
    def __init__(self,
        ...
        self.query_cross_attn = build_attention(kwargs['query_cross_attn_cfg'])
    ...
    def forward(self, x: List[Tensor],
        ...
        # learn_query_feat = self.query_cross_attn(
        #     learn_query_feat,
        #     generate_query_feat,
        #     generate_query_feat,
        #     None,
        #     query_pos=query_embed[:self.num_queries],
        #     key_pos=query_embed[self.num_queries:],
        #     attn_mask=None)
        # learn_query_feat = self.query_norm(learn_query_feat)
        generate_query_feat = self.query_cross_attn(
            generate_query_feat,
            learn_query_feat,
            learn_query_feat,
            None,
            ...
            key_pos=query_embed[:self.num_queries],
            attn_mask=None)
        generate_query_feat = self.query_norm(generate_query_feat)
        ...
        for i in range(self.num_transformer_decoder_layers):
            ...
            # learn_query_feat = query_feat[:self.num_queries]
            # generate_query_feat = query_feat[self.num_queries:]
            # learn_query_feat = self.query_cross_attn(
            #     learn_query_feat,
            #     generate_query_feat,
            #     generate_query_feat,
