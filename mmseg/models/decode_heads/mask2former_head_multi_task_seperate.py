...
from mmseg.models.utils import get_uncertain_point_coords_with_randomness
...
class MultiTaskSeperateMask2FormerHead(MMDET_Mask2FormerHead):
    ...
    def __init__(self,
        ...
        self.query_feat = nn.Embedding(self.num_queries * 2, feat_channels)
    ...
    def _loss_by_feat_single(self, cls_scores: Tensor, mask_preds: Tensor,
        ...
        loss_dice = self.loss_dice(
            mask_point_preds, mask_point_targets, weight=mask_weights, avg_factor=mask_weights.sum())
