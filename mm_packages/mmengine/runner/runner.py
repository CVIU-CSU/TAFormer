...
class Runner:
    ...
    def resume(self,
        ...
        if isinstance(self.train_dataloader, list):
            dataset_meta = getattr(self.train_dataloader[0].dataset, 'metainfo', None)
        else:
    ...
    def save_checkpoint(
        ...
        if isinstance(self.train_dataloader, list):
            if hasattr(self.train_dataloader[0].dataset, 'metainfo'):
                meta.update(dataset_meta=self.train_dataloader[0].dataset.metainfo)
        else:
