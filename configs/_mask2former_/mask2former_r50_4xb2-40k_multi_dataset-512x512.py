_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/multi_dataset_idrid_refuge_ddr.py']
...
data_preprocessor = dict(
    ...
    mean=[95.523, 57.776, 25.422],
    std=[58.273, 35.645, 16.790],
    bgr_to_rgb=True,
    pad_val=0,
    seg_pad_val=255,
    size=crop_size,
...
train_cfg = dict(type='MultiDatasetIterBasedTrainLoop', max_iters=40000, val_interval=4000)
val_cfg = dict(type='MultiDatasetValLoop')
